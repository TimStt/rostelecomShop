...
import { currentProductAddBusketSlice } from "../../shared/stores/current-product-add-busket";
import { popupShareSlice } from "@/widgets/product-card-page/ui/popup-/store";
import { orderSlice } from "../../shared/stores/order";
import { viewGoodsSlice } from "@/shared/stores/store";
...
const reducer = combineReducers({
  ...
  viewGoods: viewGoodsSlice.reducer,
